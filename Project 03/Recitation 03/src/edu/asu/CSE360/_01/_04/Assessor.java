...
/**
 *
 * @author David Edwards cse360 recitation project 3 team 4 Submitted: 10/11/2017
 */
...
public class Assessor extends JPanel {
	...
	public Assessor(QuestionProgressReport[] progressReportList) {
		...
		try {
			...
			saxParser.parse(new File("resources/content.xml"), new MyHandler());
		} catch (Exception e) {
			e.printStackTrace();
		}
